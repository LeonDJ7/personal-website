...
const About = (props) => {
    ...
    return (
        <div id='parent' style={styles['parent']}>
            <Typography id='title'> Greetings! </Typography>
